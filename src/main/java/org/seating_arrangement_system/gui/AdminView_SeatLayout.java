...
public class AdminView_SeatLayout extends JFrame implements ActionListener {
    ...
    public AdminView_SeatLayout(String title, List<Seat> data, String[] headers, int roomNumber) {
        this.data = data;
